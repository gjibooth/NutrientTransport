...
% maxc=0.3;
% cb.Ticks=[0 round(maxc/4,2) round(maxc/2,2) round((3*maxc)/4,2) round(maxc,2)];
% cb.TickLabels={0 round(maxc/4,2) round(maxc/2,2) round((3*maxc)/4,2) round(maxc,2)};
% caxis([0 0.3])
...
% %cb.Label.String = 'Surfactant Concentration, $\Gamma$';
% cb.Label.String = 'Surfactant Concentration';
% 
